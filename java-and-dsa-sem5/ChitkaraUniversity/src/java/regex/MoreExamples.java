...
public class MoreExamples {
    ...
    public static boolean castInsensitiveTest(String regex, String text) {
...
//        ^ . regex means anything but not empty
    ...
    public static void runExample2() {
        ...
        boolean matches1 = castInsensitiveTest(regex, text1);
        System.out.println(matches1);

        boolean matches2 = castInsensitiveTest(regex, text2);
        System.out.println(matches2);
    }
