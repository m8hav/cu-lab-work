package java.arrays.twoDArray.exercises;
...
//        TASK 4 - FIND SUM OF RING AROUND CENTER AND COMPARE TO PREVIOUS SUM
        if (N >= 3) {
            int sum2 = squareArr[N/2-1][N/2-1] + squareArr[N/2-1][N/2+1] + squareArr[N/2+1][N/2-1] + squareArr[N/2+1][N/2+1];
            sum2 += squareArr[N/2-1][N/2] + squareArr[N/2][N/2-1] + squareArr[N/2][N/2+1] + squareArr[N/2+1][N/2];
            System.out.println("Sum2: " + sum2);
            System.out.println();

            System.out.println(sum1 > sum2 ? "Sum1 is greater" : "Sum2 is greater");
        }
